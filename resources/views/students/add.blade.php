...
@section('content')
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Ajouter Un Eleve </h1>
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">Etape1 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbspEtape2<hr>
            <h6 class="m-0 font-weight-bold text-primary">Information eleve</h6>
        </div>
        <div class="card-body">
